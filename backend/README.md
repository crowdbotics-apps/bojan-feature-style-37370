...
## Project Structure
    ...
    ├── bojan_feature_style_37370  # Django project configurations
...
1. Clone this repo and `cd bojan_feature_style_37370`
...
2. Clone this repo and `cd bojan_feature_style_37370`
